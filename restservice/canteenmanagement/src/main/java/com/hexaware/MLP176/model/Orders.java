 ...
 * orderQuantity to store food reviews.
 */
private double venCgst;
   /**
 * orderQuantity to store food reviews.
 */
private double venSgst;
  /**
   * Default Constructor.
   */
  public Orders() {
 ...
 * @param argVenCgst to initialize food Rating.
 * @param argVenSgst to initialize food Rating.
 */
  public Orders(final int argOrderId, final int argCustomerId, final int argVendorId,
      ...
      final Date argOrderDate, final int argOrderQuantity, final WalletType argWalletType, final double argVenCgst,final double argVenSgst) {
    ...
    this.venCgst = argVenCgst;
    this.venSgst = argVenSgst;
  ...
  @Override
    ...
    return Objects.hash(orderId, customerId, vendorId, menuId, orderStatus, orderComments, orderTotalamount,
              orderDate, orderQuantity, walletType, venCgst, venSgst);
  }
  @Override
    public final String toString() {
    return String.format("%-10s %-10s %-10s %-10s %-10s %-10s %-10s %-10s %-10s %-10s %-10s %-10s", orderId, customerId, vendorId,
     menuId,  orderStatus, orderComments, orderTotalamount, orderDate, orderQuantity, walletType, venCgst,venSgst);
  }
    /**
     * @return this food ID.
     */
  ...
  public final void setWalletType(final WalletType argWalletType) {
   ...
   /**
     * @return this menu reviews.
     */
    public final double getVenCgst() {
      return venCgst;
    }
    /**
     * @param argWalletType gets the menu reviews.
     */
    public final void setVenCgst(final double argVenCgst) {
      this.venCgst = argVenCgst;
    }
     ...
     * @return this menu reviews.
     */
    public final double getVenSgst() {
      return venSgst;
    }
    /**
     * @param argWalletType gets the menu reviews.
     */
    public final void setVenSgst(final double argVenSgst) {
      this.venSgst = argVenSgst;
    }
}
