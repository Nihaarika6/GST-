...
public interface OrderDAO {
  ...
  @SqlUpdate("INSERT INTO ORDERS(ORD_ID, CUS_ID, VEN_ID, MEN_ID,"
      + "ORD_STATUS, ORD_COMMENTS, ORD_TOTAL_AMT, ORD_DATE, ORD_QTY , WAL_TYPE, CGST, SGST) "
      + " VALUES(:orderId, :customerId, :vendorId, :menuId, :orderStatus,"
      + ":orderComments, :orderTotalamount, :orderDate, :orderQuantity, :walletType, :venCgst, :venSgst);")
    @GetGeneratedKeys
